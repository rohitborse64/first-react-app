  ...
  return (
    <div className="App">
      <header className="App-header">
        ...
        <TestComponent6 
          onButtonClicked={handleTestButtonClicked1} 
          idToShow={1} 
        />

        {/* with passing custom value from App component */}
        {/* <TestComponent6 
          onButtonClicked={()=>handleTestButtonClicked2("passing value from component")} 
          idToShow={2} 
        /> */}
        ...
        <TestComponent6
          onButtonClicked={(data: string) => handleTestButtonClicked2(data)}
          idToShow={2}
        />
        ...
        <TestComponent7
          onButtonClicked={() =>
            handleTestButtonClicked3("Test component value")
          }
        />
        ...
        Counter - {counter} <br />
        Result - {result}
        <button onClick={() => setCounter((count) => count + 1)}> Hit Count </button>

        {/* ---------------- Context API hook ---------------- */}
        <hr style={newLineStyle} />
        <p> use Context API hook </p>
        <TestContext.Provider value={stateValue}>
          <MainContextHookComponent></MainContextHookComponent>
          <TestContexthookComponent></TestContexthookComponent>
          <button onClick={() => setStateValue("Set new value")}>
            Click Me!
          </button>
